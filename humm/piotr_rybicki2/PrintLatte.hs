...
instance Print TopDef where
  prt i e = case e of
    ...
    Builtin type_ id args -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")")])
...
instance Print Stmt where
  prt i e = case e of
    ...
    AssElem id expr1 expr2 -> prPrec i 0 (concatD [prt 0 id, doc (showString "["), prt 0 expr1, doc (showString "]"), doc (showString "="), prt 0 expr2, doc (showString ";")])
    ...
    For id expr1 fort expr2 stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), doc (showString "int"), prt 0 id, doc (showString "="), prt 0 expr1, prt 0 fort, prt 0 expr2, doc (showString ")"), prt 0 stmt])
...
instance Print Item where
  ...
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print ForT where
  prt i e = case e of
    ForUp -> prPrec i 0 (concatD [doc (showString "to")])
    ForDown -> prPrec i 0 (concatD [doc (showString "downto")])
...
instance Print Expr where
  prt i e = case e of
    ...
    EArrElem id expr -> prPrec i 6 (concatD [prt 0 id, doc (showString "["), prt 0 expr, doc (showString "]")])
    ...
    ELitArray exprs type_ -> prPrec i 6 (concatD [doc (showString "["), prt 0 exprs, doc (showString "] of "), prt 0 type_])
