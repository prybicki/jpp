...
Stmt : ';' { AbsLatte.Empty }
     ...
     | Ident '[' Expr ']' '=' Expr ';' { AbsLatte.AssElem $1 $3 $6 }
...
ForT :: { ForT }
ForT : 'to' { AbsLatte.ForUp } | 'downto' { AbsLatte.ForDown }
Type :: { Type }
